...
class FileConfiguration_ESTest_Adopted_Agentic {
    ...
    void testRemoveConfigWithoutExecutorThrowsNullPointerException() {
        FileConfiguration fileConfig = new FileConfiguration();
        NullPointerException exception = Assertions.assertThrows(NullPointerException.class, () -> fileConfig.removeConfig("S[w!jc="));
        boolean hasFileConfigurationFrame = false;
        for (StackTraceElement element : exception.getStackTrace()) {
            if (FileConfiguration.class.getName().equals(element.getClassName())) {
                hasFileConfigurationFrame = true;
                break;
            }
        }
        Assertions.assertTrue(hasFileConfigurationFrame);
    }
    ...
    void testTypeNameIsFileAndRemoveConfigWithLongTimeout() {
        ...
        Assertions.assertEquals("file", typeNameAfterRemoval);
    }

    @Test
    void testGetLongWithDefaultAndTimeoutWithoutExecutorThrowsNullPointerException() {
        FileConfiguration fileConfig = new FileConfiguration();
        NullPointerException exception = Assertions.assertThrows(NullPointerException.class, () -> fileConfig.getLong(",qs,r.[>5tj", ((long) (short) (125)), 0L));
        boolean hasFileConfigurationFrame = false;
        for (StackTraceElement element : exception.getStackTrace()) {
            if (FileConfiguration.class.getName().equals(element.getClassName())) {
                hasFileConfigurationFrame = true;
    ...
    void testPutConfigWithTimeoutWithoutExecutorThrowsNullPointerException() {
        FileConfiguration fileConfig = new FileConfiguration();
        NullPointerException exception = Assertions.assertThrows(NullPointerException.class, () -> fileConfig.putConfig("", "", 0L));
        boolean hasFileConfigurationFrame = false;
        for (StackTraceElement element : exception.getStackTrace()) {
            if (FileConfiguration.class.getName().equals(element.getClassName())) {
                hasFileConfigurationFrame = true;
    ...
    void testPutConfigIfAbsentWithoutTimeoutWithoutExecutorThrowsNullPointerException() {
        FileConfiguration fileConfig = new FileConfiguration();
        NullPointerException exception = Assertions.assertThrows(NullPointerException.class, () -> fileConfig.putConfigIfAbsent(null, null));
        boolean hasFileConfigurationFrame = false;
        for (StackTraceElement element : exception.getStackTrace()) {
            if (FileConfiguration.class.getName().equals(element.getClassName())) {
                hasFileConfigurationFrame = true;
    ...
    void testGetDurationWithoutTimeoutWithoutExecutorThrowsNullPointerException() {
        FileConfiguration fileConfig = new FileConfiguration();
        NullPointerException exception = Assertions.assertThrows(NullPointerException.class, () -> fileConfig.getDuration(""));
        boolean hasFileConfigurationFrame = false;
        for (StackTraceElement element : exception.getStackTrace()) {
            if (FileConfiguration.class.getName().equals(element.getClassName())) {
                hasFileConfigurationFrame = true;
